...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let imageUrls = Array(1...3).map({i in URL(string: "https://raw.githubusercontent.com/nakaji-dayo/OmniCarouselView/master/Example/OmniCarouselView/Images.xcassets/beer\(i).imageset/beer\(i).jpeg")})
